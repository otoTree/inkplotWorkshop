...
install: bun dlx shadcn@latest add <component> | bun dlx shadcn@latest add @coss/<component>
ai-elements: bun dlx shadcn@latest add "https://registry.ai-sdk.dev/<component>.json
...
prefix: `yes n | bun dlx shadcn@latest add ...` (auto-answer 'n' to overwrite prompts)
